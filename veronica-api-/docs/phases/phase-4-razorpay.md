...
- `@veronica/contracts@0.3.0` published
...
> Add Resend email.
>
> 1. Env: `RESEND_API_KEY`, `RESEND_FROM_EMAIL` (e.g. `orders@veronicaindia.com` — [TODO confirm with Ketan: domain DNS configured?]).
>
...
## Task 3.9 — Bump and publish `@veronica/contracts@0.3.0`

**Acceptance criteria**:
- [ ] `@veronica/contracts@0.3.0` published with checkout + order schemas
- [ ] Tag pushed
