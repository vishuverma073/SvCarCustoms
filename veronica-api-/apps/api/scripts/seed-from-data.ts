...
import { categoriesData, productsData } from "./seed-data.js";
...
async function main() {
  ...
  try {
    ...
    console.log(
      `✓ Seeded ${categoryCount} categories, ${productCount} products, ${dimensionCount} dimensions, ${skuCount} SKUs, ${imageCount} images, + home_config & settings singletons`,
    );
  } finally {
    await sql.end();
  }
