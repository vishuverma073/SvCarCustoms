...
<html><body style="font-family:Arial,Helvetica,sans-serif;color:#222;max-width:480px;margin:0 auto;padding:24px">
  ...
  <p style="color:#888;font-size:12px;margin-top:24px">SV Car Customs</p>
</body></html>`;
}
...
${
  ...
  <p style="color:#888;font-size:12px;margin-top:24px">SV Car Customs · Need help? Reply to this email.</p>
</body></html>`;
}
