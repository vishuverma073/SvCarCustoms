 ...
 *
 * Today the seed images are static files in svcar-india/public/uploads/ and
...
const UPLOADS_DIR =
  ...
  fileURLToPath(new URL("../../../../svcar-india/public/uploads/", import.meta.url));
...
async function main() {
  ...
  console.log(
    APPLY
      ? "\n✅ Done. Images are in Supabase Storage and DB URLs updated. You can delete svcar-india/public/uploads/."
