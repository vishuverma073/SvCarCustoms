...
- `@svcar/contracts@0.2.0` published with new auth + cart schemas
...
>    - `JWT_ISSUER: z.string().default("svcar-api")`
>
...
## Task 2.8 — Bump and publish `@svcar/contracts@0.2.0`

**Suggested Claude Code prompt**:
> Bump `packages/contracts/package.json` to `0.2.0`. Build and publish. Tag.

**Acceptance criteria**:
- [ ] `@svcar/contracts@0.2.0` published
- [ ] Tag pushed
