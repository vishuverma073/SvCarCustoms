...
response shape is byte-identical to what the frontend's `@veronica/contracts`
...
cookie-based auth**. `/auth/otp/verify` sets an httpOnly `veronica_refresh`
