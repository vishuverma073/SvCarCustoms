...
export const metadata: Metadata = {
    title: "Refund & Return Policy — Veronica India",
    description:
        "Our return window, eligibility, and how refunds are processed for orders placed on Veronica India.",
        ...
        <div className="max-w-3xl mx-auto px-4 py-14">
            ...
            <div className="space-y-8 text-[15px] text-text-secondary leading-relaxed [&_h2]:text-lg [&_h2]:font-bold [&_h2]:text-text-primary [&_h2]:mb-2 [&_h2]:mt-0 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1.5 [&_a]:text-brand-orange [&_a:hover]:underline">
                ...
                <section>
                    ...
                    <ul>
                        <li>Items that have been installed, used or damaged after delivery.</li>
                        <li>Products returned without their original packaging or accessories.</li>
                        <li>Made-to-order or customised items, unless they arrived defective.</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <ul>
                        <li>Email <a href="mailto:veronicasanitarygoods@gmail.com">veronicasanitarygoods@gmail.com</a> or message us on <a href="https://wa.me/919350529717" target="_blank" rel="noopener noreferrer">WhatsApp</a> with your order number and reason.</li>
