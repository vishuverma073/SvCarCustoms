# Veronica India — Production Planning Docs
...
These are **reference docs** — read once, refer back occasionally. For **execution playbooks** an intern can work through with Claude Code, see [../phases/README.md](../phases/README.md) (frontend tasks) and `veronica-api/docs/phases/` (backend tasks).
...
| [03-data-model.md](./03-data-model.md) | (Moved) Postgres schema design — see `veronica-api/docs/01-data-model.md` |
| [04-phases.md](./04-phases.md) | Phase 0 through Phase 6 — **high-level overview only**; detailed task lists live in `docs/phases/` (FE) and `veronica-api/docs/phases/` (BE) |
