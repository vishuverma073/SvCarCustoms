...
- [ ] Sentry project supports a "browser" environment (or create a second one named `veronica-web`)
...
> ```
> POST https://veronicaindia.com/api/revalidate
...
**Suggested Claude Code prompt**:
> Manual:
> 1. Open https://veronicaindia.com in an incognito window
