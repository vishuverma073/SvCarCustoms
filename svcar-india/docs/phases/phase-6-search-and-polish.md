...
- [ ] `@svcar/contracts@1.0.0` installed
...
> ```
> { "@context": "https://schema.org", "@type": "Product", "name", "description", "image", "brand": "Svcar India", "sku", "offers": { "@type": "AggregateOffer", "lowPrice", "highPrice", "priceCurrency": "INR", "availability": "https://schema.org/InStock" } }
> ```
...
>   - Overlay: gradient + Svcar logo + product name + price ("From ₹X")
...
> - Verify color contrast (Svcar orange on white = check it passes WCAG AA for normal text size)
...
> 5. Custom domain on backend (api.svcarindia.com) — point DNS to Workers/Fly
