...
This is the source of truth for how the admin panel looks and behaves on the frontend. Backend implications are in [svcar-api/docs/admin-design.md](../../svcar-api/docs/admin-design.md).
