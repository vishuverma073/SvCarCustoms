...
Monitor:
- `https://svcar.com/` (frontend) every 1 min
- `https://api.svcar.com/healthz` (backend) every 1 min
- `https://api.svcar.com/webhooks/razorpay-health` (synthetic ping endpoint) every 5 min
