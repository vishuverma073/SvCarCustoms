...
Reference index of the production rollout. For execution detail, see the per-phase docs in `docs/phases/` (frontend) and `svcar-api/docs/phases/` (backend).
...
**In parallel**, not serial. FE uses MSW to mock the API based on the published `@svcar/contracts` schemas. Each phase ends at an **integration milestone** (M0-M6 — see `docs/integration-milestones.md`) where the FE flips from mocks to staging backend and both interns run the integration checklist.
...
|---|---|---|
| 0 | [svcar-api/docs/phases/phase-0-foundations.md](../../../svcar-api/docs/phases/phase-0-foundations.md) | [phase-0-foundations.md](../phases/phase-0-foundations.md) |
| 1 | `svcar-api/docs/phases/phase-1-admin.md` | [phase-1-admin.md](../phases/phase-1-admin.md) |
| 2 | `svcar-api/docs/phases/phase-2-read-paths.md` | [phase-2-read-paths.md](../phases/phase-2-read-paths.md) |
| 3 | `svcar-api/docs/phases/phase-3-auth-and-cart.md` | [phase-3-auth-and-cart.md](../phases/phase-3-auth-and-cart.md) |
| 4 | `svcar-api/docs/phases/phase-4-razorpay.md` | [phase-4-razorpay.md](../phases/phase-4-razorpay.md) |
| 5 | `svcar-api/docs/phases/phase-5-caching-and-obs.md` | [phase-5-caching-and-obs.md](../phases/phase-5-caching-and-obs.md) |
| 6 | `svcar-api/docs/phases/phase-6-search-and-polish.md` | [phase-6-search-and-polish.md](../phases/phase-6-search-and-polish.md) |
