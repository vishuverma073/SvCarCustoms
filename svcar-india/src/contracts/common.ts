...
/**
 * Shared primitives for the SV Car Customs contracts.
 *
 * These local schemas stand in for the future `@svcar/contracts` npm package.
 * Everything in the app imports them via the `@svcar/contracts` path alias
