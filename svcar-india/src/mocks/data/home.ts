  ...
  sections: [
    {
      ...
      order: 0,
      config: {
        imageUrl: "https://placehold.co/1600x900/0A0A0A/E11D2A/png?text=SV+Car+Customs",
    ...
    { key: "featured", enabled: true, order: 4, config: { productIds: [1, 7, 11] } },
    {
      key: "promo",
      enabled: true,
      order: 5,
      config: {
        imageUrl: "https://placehold.co/1600x600/0A0A0A/E11D2A/png?text=Up+to+40%25+Off",
        headline: "Festive Sale — Up to 40% Off",
        ctaText: "View Offers",
        ctaHref: "/category/body-kits",
      },
    },
  ],
};
