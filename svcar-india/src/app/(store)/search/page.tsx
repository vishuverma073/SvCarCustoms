...
import { Search, ChevronRight, SearchX, Package, Car } from "lucide-react";
...
function SearchPageContent() {
    ...
    const search = useCallback(async (q: string) => {
        ...
        setError(false);
        try {
            // When a garage vehicle is set + the "fits my car" filter is on, use the
            // fitment-aware catalog list (q + make/model/year); otherwise plain search.
            const items =
                fitsActive && vehicle
                    ...
                    : await backend.searchProducts(q);
            ...
            <div className="relative mb-10">
                ...
                {hydrated && vehicle && (
                    <label className="mt-3 flex items-center gap-2 text-[13px] font-medium text-text-secondary cursor-pointer select-none">
                        ...
                        Only show parts that fit my {vehicleLabel(vehicle)}
                    </label>
                )}
            </div>
            ...
            {!loading && !error && query && results.length === 0 && (
                <div className="empty-state">
                    ...
                    <p className="text-sm text-text-muted">
                        Try searching for &quot;body kit&quot;, &quot;spoiler&quot;, or &quot;exhaust&quot;
                    </p>
                </div>
            )}
                ...
                <div className="animate-fade-in">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {["Body Kit", "Spoiler", "Ambient Lights", "Exhaust", "Paddle Shifters", "Subwoofer"].map((term) => (
                                <button
                                    key={term}
                                    type="button"
