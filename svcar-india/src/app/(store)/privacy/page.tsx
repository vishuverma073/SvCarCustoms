...
export const metadata: Metadata = {
    title: "Privacy Policy — SV Car Customs",
    description:
        "How SV Car Customs collects, uses, and protects your personal information when you shop with us.",
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-14">
            ...
            <div className="space-y-8 text-[15px] text-text-secondary leading-relaxed [&_h2]:text-lg [&_h2]:font-bold [&_h2]:text-text-primary [&_h2]:mb-2 [&_h2]:mt-0 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1.5 [&_a]:text-brand-orange [&_a:hover]:underline">
                <section>
                    <p>
                        SV Car Customs (&ldquo;we&rdquo;, &ldquo;us&rdquo;) respects your privacy. This
                        policy explains what information we collect when you visit
                        svcarcustoms.com or place an order, how we use it, and the choices you
