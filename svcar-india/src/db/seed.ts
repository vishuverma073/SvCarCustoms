...
const categoryData = [
    {
        ...
        image: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Body+Kits",
        sortOrder: 1,
    },
    {
        name: "Spoilers",
        ...
        image: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Spoilers",
        sortOrder: 2,
    },
    {
        name: "Lighting",
        ...
        image: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Lighting",
        sortOrder: 3,
    },
    {
        name: "Exhausts & Tips",
        ...
        image: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Exhausts+%26+Tips",
        sortOrder: 4,
    },
    {
        name: "Interior",
        ...
        image: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Interior",
        sortOrder: 5,
    },
    {
        name: "Exterior",
        ...
        image: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Exterior",
        sortOrder: 6,
    },
    {
        name: "Audio",
        ...
        image: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Audio",
        sortOrder: 7,
    },
];
...
const productData = [
    // Body Kits (category 1) — Full Body Kits / Front Splitters
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Apex+Aero+Full+Body+Kit", alt: "Apex Aero Full Body Kit" },
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Apex+Aero+Front+Bumper", alt: "Apex Aero front bumper" },
        ],
        variants: [
    ...
    },
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Street+Stance+Wide+Body+Kit", alt: "Street Stance Wide Body Kit" },
        ],
        variants: [
    ...
    },
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Carbon+Fibre+Front+Splitter", alt: "Carbon Fibre Front Splitter" },
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Front+Splitter+Detail", alt: "Front Splitter detail" },
        ],
        variants: [
    ...
    // Spoilers (category 2) — Lip Spoilers / GT Wings
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Ducktail+Boot+Lip+Spoiler", alt: "Ducktail Boot Lip Spoiler" },
        ],
        variants: [
            { name: "Finish", value: "Gloss Black", priceAdjustment: 0 },
    ...
    },
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Pro+GT+Wing+Spoiler", alt: "Pro GT Wing Spoiler" },
        ],
        variants: [
            { name: "Finish", value: "Gloss Black", priceAdjustment: 0 },
    ...
    // Lighting (category 3) — Ambient Lights / Tail Lights
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=RGB+Ambient+Interior+Light+Kit", alt: "RGB Ambient Interior Light Kit" },
        ],
        variants: [
    ...
    },
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Smoked+LED+Sequential+Tail+Lights", alt: "Smoked LED Sequential Tail Lights" },
        ],
        variants: [
    ...
    // Exhausts & Tips (category 4) — Exhaust Systems / Exhaust Tips
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Cat-Back+Performance+Exhaust+System", alt: "Cat-Back Performance Exhaust System" },
        ],
        variants: [
    ...
    },
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Carbon+Fibre+Slant-Cut+Exhaust+Tip", alt: "Carbon Fibre Slant-Cut Exhaust Tip" },
        ],
        variants: [
    ...
    // Interior (category 5) — Paddle Shifters / Interior Trims
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Aluminium+Paddle+Shifter+Extensions", alt: "Aluminium Paddle Shifter Extensions" },
        ],
        variants: [
    ...
    },
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Carbon+Fibre+Interior+Trim+Kit", alt: "Carbon Fibre Interior Trim Kit" },
        ],
        variants: [
    ...
    // Exterior (category 6) — Custom Kits
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Murdered-Out+Blackout+Styling+Kit", alt: "Murdered-Out Blackout Styling Kit" },
        ],
        variants: [
            { name: "Fitment", value: "Universal", priceAdjustment: 0 },
    ...
    // Audio (category 7) — Speakers / Subwoofers
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Pro+Component+Speaker+System", alt: "Pro Component Speaker System" },
        ],
        variants: [
    ...
    },
    {
        ...
        images: [
            { url: "https://placehold.co/800x800/0C0C0D/E11D2A/png?text=Active+Underseat+Subwoofer", alt: "Active Underseat Subwoofer" },
        ],
        variants: [
