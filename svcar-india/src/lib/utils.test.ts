...
describe("slugify", () => {
    ...
    it("collapses multiple spaces and hyphens", () => {
        expect(slugify("Svcar  India --  Sinks")).toBe("svcar-india-sinks");
    });
    ...
    it("handles real product names", () => {
        ...
        expect(slugify("Svcar Square Floor Drain (Cockroach Trap)")).toBe(
            "svcar-square-floor-drain-cockroach-trap"
        );
    });
});
...
describe("generateWhatsAppUrl", () => {
    ...
    it("includes the encoded message text", () => {
        ...
        expect(url).toContain("SV%20Car%20Customs");
    });
